...
namespace WebApplication1.Services
{
    public class BrugerService : Repository<Bruger>
    {
        ...
        {
            return $"'{bruger.Navn}', '{bruger.Email}', '{bruger.Kodeord}', {bruger.Rolle.Id}, {bruger.SkoleId}, '{bruger.SletningsDato.Year+"-"+ bruger.SletningsDato.Month+"-"+ bruger.SletningsDato.Day}'";
        };
